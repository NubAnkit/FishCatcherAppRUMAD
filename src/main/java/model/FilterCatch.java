...
public class FilterCatch extends JsonModel {
	...
	public void setMin_width(String max_width) {
		this.max_width = max_width;
	}
	
	public String projectionExpression() {
		String pExpress = "userId, lat, lon, "; 
	...
	public String filterExpression() {
		...
		if(!(this.min_width == (null))) {
			fExpress += "(width between :min_width and :max_width) and "; 
		}
		if(!(this.min_weight == (null))) {
	...
	public ValueMap filterMap() {
		...
		if(!(this.min_width == (null))) {
			vm.withNumber(":min_width", toDouble(this.min_width)).withNumber(":max_width", toDouble(this.max_width));
		}
		if(!(this.min_weight == (null))) {
